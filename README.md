...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/authlib-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6456&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/authlib-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `authlib` can be installed with:

```
conda install authlib
```

It is possible to list all of the versions of `authlib` available on your platform with:
